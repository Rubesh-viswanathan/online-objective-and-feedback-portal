...
<div class="navbar-nav-scroll">
  ...
  <li class="nav-item dropdown">
      ...
      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bd-versions">
        ...
        <div class="col-10" >
        <div id="response" style="text-align:center;font-size:18px;"></div>
        <div class="container-fluid" >
            <?php
            $row;
            $sql="select question,ot1,ot2,ot3,ot4,cot,img from qt where id=".$_SESSION['qn'][($_SESSION['qno']-1)]."";
            ...
            <div class="card" id="ques">
                ...
                ?>
                        <p class="card-text">
                            <form id="answerform" method="post" autocomplete="on">
                            <pre><?php echo htmlentities($_SESSION['qno']);
                            echo". ";
                            echo htmlentities($row['question']);
                           ?></pre>
                        </p>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><input type="radio" name="answer" value="<?php echo htmlentities($row[$options[0]]);?>" id="ot1" onclick="document.getElementById('submit').click()"> <?php echo htmlentities($row[$options[0]]);?></li>
                            <li class="list-group-item"><input type="radio" name="answer" value="<?php echo htmlentities($row[$options[1]]);?>" id="ot2" onclick="document.getElementById('submit').click()"> <?php echo htmlentities($row[$options[1]]);?></li>
                            <li class="list-group-item"><input type="radio" name="answer" value="<?php echo htmlentities($row[$options[2]]);?>" id="ot3" onclick="document.getElementById('submit').click()"> <?php echo htmlentities($row[$options[2]]);?></li>
                            <li class="list-group-item"><input type="radio" name="answer" value="<?php echo htmlentities($row[$options[3]]);?>" id="ot4" onclick="document.getElementById('submit').click()"> <?php echo htmlentities($row[$options[3]]);?></li>
                        </ul>
                    </div>
                    </div> 
                <input type="submit" value="Prev"class="btn" name="previous"id="prev">
                <input type="submit" value="Next"class="btn" name="next"id="next">
                <input type="submit" value="Submit"class="btn" name="submit"id="submit"style="display:none;" >
