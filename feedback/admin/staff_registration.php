...
function validateForm() {
    ...
    var x = document.forms["studentreg"]["staffname"].value;
...
function validateForm() {
    ...
    var x = document.forms["studentreg"]["staffid"].value;
...
function validateForm1() {
    ...
    var x = document.forms["studentreg"]["department"].value;
...
<div class="navbar-nav-scroll">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link active"href="staff_registration.php">Staff Registration</a>
...
<label for="studentregno">Staff Id   </label>

<input type="text" class="form-control" id="staffid" name="staffid" onBlur="userAvailability()" placeholder="Staff Id" required />
