...
if(isset($_POST['id']))
{
  ...
  header("location:quespreview.php");
}
...
<div class="navbar-nav-scroll">
  ...
  <li class="nav-item dropdown">
    ...
    <div class="card-group">
                       ...
                       <?php
                        $row;
                        $numb=1;
                        $sql='select * from addtest where hostedby="'.$_SESSION['login_user'].'"';
  ...
  <div class="card-body ">
    ...
    <?php
        $query='select isLive from addtest where tid='.$row['tid'];
  ...
  <form method="post">
    ...
    <input type="submit" class="btn btn-primary" value ="VIEW" id="<?php echo $numb?>" >
